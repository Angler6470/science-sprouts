...
useEffect(() => {
  ...
  return (
    <div className={`h-[100dvh] ${safeTheme.bg} flex flex-col items-center p-3 font-sans ${safeTheme.textColor || 'text-stone-800'} overflow-hidden relative transition-colors duration-500`}>
      {showSplash && (
